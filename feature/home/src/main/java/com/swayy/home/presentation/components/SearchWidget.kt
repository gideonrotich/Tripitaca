...
fun MainAppBar(
    ...
    Box(
        modifier
            .padding(start = 30.dp, end = 30.dp, bottom = 20.dp, top = 6.dp).background(androidx.compose.material3.MaterialTheme.colorScheme.primary)
    ) {
...
fun DefaultAppBar(
    ...
    TopAppBar(
        ...
        title = {
            Text(
                text = "Search listing by location",
                color = Color.Gray,
                fontSize = 16.sp,
